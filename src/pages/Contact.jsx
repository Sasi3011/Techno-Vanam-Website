      ...
      <form onSubmit={handleSubmit} className="mt-3 sm:mt-6 md:mt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 md:gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-2 sm:px-4 py-1.5 sm:py-2 md:py-3 rounded-md border-2 transition-all outline-none placeholder:text-xs sm:placeholder:text-base md:placeholder:text-lg placeholder-gray-400 ${
                formSubmitted && !name.trim()
                  ? "border-red-500"
            ...
            {servicesList.map((service, index) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-between p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-3xl bg-white shadow cursor-pointer border-2 sm:border-4 transition-all duration-300 ease-in-out min-h-[120px] sm:min-h-[140px] md:min-h-[180px] lg:min-h-[200px] ${
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            className={`w-full resize-none px-3 sm:px-4 py-2 sm:py-3 md:py-4 rounded-md border-2 transition-all outline-none placeholder:text-xs sm:placeholder:text-base md:placeholder:text-lg placeholder-gray-400 ${
              formSubmitted && message.trim() === ""
