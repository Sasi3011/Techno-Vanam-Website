  ...
  return (
    <div className="max-w-[90%] sm:max-w-4xl md:max-w-5xl lg:max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 sm:px-4 py-2 sm:py-3 rounded-md border-2 transition-all outline-none placeholder-gray-500 
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-md border-2 border-gray-200 hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all outline-none placeholder-gray-500"
          />
        </div>
      ...
      <div className="mt-6 sm:mt-10">
        <p className="text-sm sm:text-lg font-semibold text-gray-800 mb-4">
          ...
          {servicesList.map((service, index) => {
            ...
            return (
              <button
                ...
                className={`w-full min-h-[120px] sm:min-h-[180px] flex flex-col items-center p-3 sm:p-4 pt-4 sm:pt-6 bg-white rounded-3xl sm:rounded-4xl shadow cursor-pointer border-2 transition-all duration-300 ease-in-out 
                ${isSelected ? service.color : "border-gray-200 hover:border-gray-400"}`}
              >
                <img
                  src="https://via.placeholder.com/150"
                  alt={service.name}
                  className="mb-4 sm:mb-7 w-12 h-12 sm:w-17 sm:h-20 object-cover rounded-xl sm:rounded-2xl shadow-sm"
                />
      ...
      <div className="mt-6 sm:mt-10">
        <p className="text-sm sm:text-lg font-semibold text-gray-800 mb-4">What kind of project are you looking for?</p>
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          {['One-time project', 'Ongoing maintenance', 'Both'].map((type, index) => (
            <label
              key={index}
              className="flex items-center gap-3 sm:gap-4 px-4 sm:px-8 py-3 sm:py-6 rounded-3xl sm:rounded-4xl border-2 border-gray-300 hover:border-blue-500 cursor-pointer transition-all w-full"
            >
              <input
                type="radio"
                name="projectType"
                ...
                className="form-radio text-blue-600 scale-125 sm:scale-150"
              />
      ...
      <div className="mt-6 sm:mt-10">
        <p className="text-sm sm:text-lg font-semibold text-gray-800 mb-4">When is the project deadline?</p>
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {['ASAP', '1 month', '2 – 3 months', '3+ months'].map((deadlineOption, index) => (
            <label
              key={index}
              className="flex items-center gap-3 sm:gap-4 px-4 sm:px-8 py-3 sm:py-6 rounded-3xl sm:rounded-4xl border-2 border-gray-300 hover:border-blue-500 cursor-pointer transition-all w-full text-sm sm:text-base font-semibold text-gray-700"
            >
              <input
                type="radio"
                name="deadline"
      ...
      <div className="mt-6 sm:mt-10">
        <p className="text-sm sm:text-lg font-semibold text-gray-800 mb-2">
        ...
        <textarea
          ...
          className={`w-full resize-none px-3 sm:px-4 py-2 sm:py-3 rounded-md border-2 transition-all outline-none placeholder-gray-500 ${
            formSubmitted && message.trim() === ""
